...
public class ActivityMultipleChoiceQuestionBindingImpl extends ActivityMultipleChoiceQuestionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.questionText, 1);
        sViewsWithIds.put(R.id.radioGroup, 2);
        sViewsWithIds.put(R.id.radioButton5, 3);
    ...
    public ActivityMultipleChoiceQuestionBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
